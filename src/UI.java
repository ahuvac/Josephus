...
import javax.swing.JOptionPane;
    public class UI
    {
        ...
        public static int getInt(Source source, String prompt, int min)
        {
            return getInt(source, prompt, min,  Integer.MAX_VALUE, true);
        }
        /**
...
//                    : prompt;
            ...
            do
            {
                strUserInput = getString(source, prompt);
                try
                {
